...
/*   Updated: 2025/04/22 22:11:22 by tookuyam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool		is_hit_one_object(const t_rt *rt, const t_ray *ray);
static t_ray	rt_generate_shadow_ray(
					const t_vector *from, const t_vector *to);
...
static t_ray	rt_generate_shadow_ray(const t_vector *from, const t_vector *to)
{
